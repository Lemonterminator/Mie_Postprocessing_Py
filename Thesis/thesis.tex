...
Marine propulsion has entered a rapid decarbonisation phase driven by climate-target deadlines. The 2023 IMO greenhouse-gas strategy imposes increasingly stringent carbon-intensity targets while also 
...
Addressing this need, however, depends on having the right tools.
...
The remainder of this thesis is organised as follows. Chapter 2 reviews the literature and establishes the technical rationale, situating the work in diesel spray imaging, optical diagnostics, and surrogate modelling. Chapter 3 describes the research materials and methods, covering the experimental data, image-processing workflow, feature extraction, trajectory fitting, and model-training procedure. Chapter 4 reports the results, including the archived processing assets and the accumulated model evidence. Chapter 5 gathers the conclusions, summarising the current outcome, main limitations, and future development priorities.
...
\caption{Overview of the multi-hole top-view Mie scattering video processing pipeline, from raw \texttt{.cine} recordings through calibration, CUDA-accelerated preprocessing, plume registration, penetration extraction, and CSV export.}
