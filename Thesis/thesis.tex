...
Directly treating it as an inverse problem: 
attempting to reconstruct a full physical spray state from pixel intensity is an ill-posed problem and has been treated as impractical for decades.
...
In contrast to common back-illumination, side-view, or timble-based single-hole isolation configuration, 
