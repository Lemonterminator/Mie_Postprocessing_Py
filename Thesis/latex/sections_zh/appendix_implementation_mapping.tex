...
空间右删失审计脚本 & \codepath{MLP/curve\_fit/audit\_cdf\_spatial\_censoring.py} \\
...
基于喷束的CDF贯穿距离估计器 & \texttt{penetration\_cdf\_all\_plumes} \\
轴向CDF前沿定位器 & \texttt{penetration\_cdf\_front} \\
次级特征提取器 & \texttt{extract\_single\_plume\_features} \\
二值 plume 视频修补函数 & \texttt{repair\_binary\_plume\_video} \\
...
轴向二值贯穿距离度量 & \texttt{penetration\_bw\_x} \\
极坐标二值贯穿距离度量 & \texttt{penetration\_bw\_polar} \\
清洗后的CDF贯穿距离 & \texttt{penetration\_cdf clean} \\
