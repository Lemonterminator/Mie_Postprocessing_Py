...
% ---------------------------------------------------------------------
\begin{frame}{Stage 1 validation: leave-one-nozzle-out feature ablation}
\scriptsize
...
% ---------------------------------------------------------------------
\begin{frame}{Stage 2: an early-time physics anchor stabilizes OOD}
\small
...
% ---------------------------------------------------------------------
\begin{frame}{Stage 3: raw-CDF refinement with regime-aware supervision}
\small
...
residual/FiLM/SVGP family adapter. The additive-residual multitask SVGP is the
new best \emph{and} the only variant that also repairs the extrapolated-$Q_1$ tail.
