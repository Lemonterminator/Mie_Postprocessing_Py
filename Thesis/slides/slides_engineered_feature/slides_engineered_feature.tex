...
On the refreshed \num{692942}-point full-clean protocol, the production
\(\Delta P^{0.5}\) Stage-3 MLP reaches \good{RMSE \SI{4.735}{mm} \(\pm\) \SI{0.037}{mm}}
over five seeds. On the stricter uncensored CDF table, the same five-seed mean is
\good{\SI{4.265}{mm} \(\pm\) \SI{0.040}{mm}}.
\end{block}

\begin{block}{Baseline context}
The same refreshed full-clean comparison gives RMSE \SI{11.268}{mm} for
calibrated Hiroyasu--Arai, \SI{10.545}{mm} for Naber--Siebers delay, and
\SI{4.628}{mm} for Stage~3 SVGP. The feature change is still central, but the
latest architecture claim is ``competitive with SVGP'', not ``ahead of SVGP''.
\end{block}
...
\scriptsize\url{Thesis/generated/baseline_comparison_20260521/headline_full_clean.csv} \\
