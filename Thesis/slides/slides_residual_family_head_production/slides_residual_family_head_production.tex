...
\footnotesize
\centering
Direct head; residual; FiLM. Cells show status and fallback.
\end{frame}
...
{\scriptsize \textbf{The architecture} --- direct family head, additive residual, and last-block FiLM; fallback is explicit for an unknown family.}
...
% ------------------------------------------------------------------
\begin{frame}{Appendix: Code-aligned architecture detail}
\begin{center}
