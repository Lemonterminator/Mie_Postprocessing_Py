...
def bw_boundaries_all_points_single_plume(*args, **kwargs):
    """Lazy legacy wrapper to avoid importing analysis modules eagerly."""
    from OSCC_postprocessing.analysis.single_plume import bw_boundaries_all_points_single_plume

    return bw_boundaries_all_points_single_plume(*args, **kwargs)


def bw_boundaries_xband_filter_single_plume(*args, **kwargs):
    """Lazy legacy wrapper to avoid importing analysis modules eagerly."""
    from OSCC_postprocessing.analysis.single_plume import bw_boundaries_xband_filter_single_plume

    return bw_boundaries_xband_filter_single_plume(*args, **kwargs)
