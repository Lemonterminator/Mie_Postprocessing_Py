...
Usage
-----
    python MLP/MLP_training/run_stage1_lono_ablation.py
    python MLP/MLP_training/run_stage1_lono_ablation.py --device cpu
    python MLP/MLP_training/run_stage1_lono_ablation.py --n-folds 3
    python MLP/MLP_training/run_stage1_lono_ablation.py --dry-run
"""
