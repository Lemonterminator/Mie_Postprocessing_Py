...
Inputs are the CSV/JSON/PNG artifacts under
``MLP/synthetic_data/fit_diagnostics`` plus clean CDF fit tables. Outputs are
placed under ``fit_diagnostics/slides_mechanical_engineers``.
"""
...
def collect_stats() -> dict:
    """Read fit-diagnostic artifacts and condense them into slide-ready stats."""
