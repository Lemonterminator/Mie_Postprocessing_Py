...
Joins the existing per-plume censoring labels (from
``reports.audit_cdf_spatial_censoring``) onto an NN evaluation ``points.csv``
and produces:
...
This is useful after ``reports.audit_cdf_spatial_censoring`` has produced plume
