...
``build_cdf_right_censoring_point_table``.
...
Run once after each ``fit_raw_data.py`` + ``build_cdf_right_censoring_point_table``
refresh.
"""
...
def main() -> None:
    ...
    if not summary_csv.exists():
        raise FileNotFoundError(
            ...
            "Run build_cdf_right_censoring_point_table.py first."
        )
