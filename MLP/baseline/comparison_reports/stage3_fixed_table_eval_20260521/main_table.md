# Stage-3 Fixed-Table Evaluation

Evaluation tables:
- CDF uncensored: `MLP\synthetic_data\cdf_right_censoring_points\cdf_points_uncensored.csv`
- P50 observed/Q1 fit: `MLP\synthetic_data\p50_q1_oracle\p50_q1_observed_fit_points.csv`
- Q1 0-5 ms grid: `MLP\synthetic_data\p50_q1_oracle\p50_q1_predictions.csv`
